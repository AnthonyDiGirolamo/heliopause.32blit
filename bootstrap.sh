...
THIRTYTWO_BLIT_PROJECT_ROOT="$(_bootstrap_abspath "$(dirname "$_BOOTSTRAP_PATH")")"
export THIRTYTWO_BLIT_PROJECT_ROOT
PW_PROJECT_ROOT="$THIRTYTWO_BLIT_PROJECT_ROOT"
PW_ROOT="$THIRTYTWO_BLIT_PROJECT_ROOT/third_party/pigweed"

# Set your project's banner and color.
export PW_BRANDING_BANNER="$THIRTYTWO_BLIT_PROJECT_ROOT/banner.txt"
export PW_BRANDING_BANNER_COLOR=magenta

THIRTYTWO_BLIT_PROJECT_banner() {
...
export BLIT_SDK_PATH="$THIRTYTWO_BLIT_PROJECT_ROOT/third_party/32blit-sdk"
