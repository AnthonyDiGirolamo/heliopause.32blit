 ...
 * 2012-03-09 by Stefan Gustavson (original Java source code in the public
 * domain). http://webstaff.itn.liu.se/~stegu/simplexnoise/SimplexNoise.java:
...
static float grad(int32_t hash, float x) {
  ...
  //  float grad = gradients1D[h];    // NOTE : Test of Gradient look-up table
